...
from components import sidebar, header, summary_cards, connections_cards, messages_cards
...
def wireframe_layout(app: Dash, data: dict) -> dbc.Container:
    ...
    layout = dbc.Container(children=[
        ...
        header.render(data["owner_first_name"], data["start_init_dt"], data["end_init_dt"]),
